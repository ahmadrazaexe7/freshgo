...
export const productRates: ProductRate[] = [
  ...
  { id: "veg-potatoes", name: "Potato", displayName: "آلو", category: "vegetables", unit: "1 kg", price: round(38 * 1.15) },
  { id: "veg-onions", name: "Onion", displayName: "پیاز", category: "vegetables", unit: "1 kg", price: round(89 * 1.15) },
  { id: "veg-tomatoes", name: "Tomato", displayName: "ٹماٹر", category: "vegetables", unit: "1 kg", price: round(79 * 1.15) },
  { id: "veg-ginger", name: "Ginger (China)", displayName: "ادرک (چین)", category: "vegetables", unit: "1 kg", price: round(450 * 1.15) },
  { id: "veg-garlic", name: "Garlic (China)", displayName: "لہسن (چین)", category: "vegetables", unit: "1 kg", price: round(389 * 1.15) },
  ...
  { id: "veg-zucchini", name: "Green Zucchini", displayName: "زکینی", category: "vegetables", unit: "1 kg", price: round(109 * 1.15) },
  ...
  { id: "fruit-bananas", name: "Banana", displayName: "کیلا", category: "fruits", unit: "dozen", price: round(180 * 1.15) },
  ...
  { id: "fruit-strawberries", name: "Strawberry", displayName: "اسٹرابیری", category: "fruits", unit: "500 g", price: round(300 * 1.15) },
